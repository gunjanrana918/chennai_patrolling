...
class _IncidentrecordState extends State<Incidentrecord> {
  ...
  NewfileUpload() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Incident'));
  ...
  sendMail() async {
    ...
    final message = Message()
      ...
      ..recipients.add('operations.gdlc@gatewaydistriparks.com') //recipent email
      ..ccRecipients.addAll(['gunjan.rana@gatewaydistriparks.com','itsupport.gdlm@gatewaydistriparks.com'])  //cc Recipents emails
...
// Get Location information by API
  ...
  _getStateList() async {
    ...
    var request = http.Request(
        'GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Location'));
