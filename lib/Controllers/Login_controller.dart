...
class Logincontroller extends GetxController {
  ...
  loginbutton(context) async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Login'));
  ...
  class Profilecontroller extends GetxController{
    ...
    updateprofile(context) async {
      ...
      var request = http.Request('POST', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/updateUserProfile'));
      request.body = json.encode({
...
class Schedulecontroller extends GetxController{
  ...
  List<NightRound> nightround = [];
   ...
   Future<void> Getschedule()  async{
    ...
    try {
      var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Count'));
      request.body = json.encode({
        "UserId": globaldata.GID,
        "ReportType":"Count"
      });
 ...
 Future<DayRound?> Dayschedule() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Schedule'));
    request.body = json.encode({
      "UserId": globaldata.GID,
      "ReportType":"Day"
    });
...
class Completecontroller extends GetxController{
 ...
 Future<void> CtotalRound() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/CompleteCount'));
    request.body = json.encode({
      "UserId": globaldata.GID,
      "ReportType": "Count"
    });
  ...
  Future<CompleteDayRound?> CompleteDayschedule() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/CompleteRound'));
    request.body = json.encode({
      "UserId": globaldata.GID,
      "ReportType":"Day"
    });
...
class Nextroundcontroller extends GetxController{
  ...
  Future<NextRound?> Nextroundschedule() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/nextround'));
    request.body = json.encode({
      "UserId": globaldata.GID
    });
    request.headers.addAll(headers);
...
class Lastroundcontroller extends GetxController{
  ...
  Future<LastRound?>Lasttroundschedule() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/lastround'));
    request.body = json.encode({
      "UserId": globaldata.GID
    });
    request.headers.addAll(headers);
...
class Getlocation extends GetxController{
  ...
  mylocation() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Location'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    var responseData = await response.stream.bytesToString();
    if(response.statusCode == 200){
...
int index=0;
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/DayHistory'));
    request.body = json.encode({
      "UserId": globaldata.GID
    });
    request.headers.addAll(headers);
...
class NightRoundhistory extends GetxController{
  ...
  NightSummary() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/NightHistory'));
    request.body = json.encode({
      "UserId": globaldata.GID
    });
    request.headers.addAll(headers);
...
class Fpasswordcontroller extends GetxController {
  ...
  resetpassword() async {
    ...
    var request = http.Request('POST', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/forgotpwd'));
    request.body = json.encode({
...
class OTPvalidcontroller extends GetxController{
  ...
  MobileOTP(context) async {
    ...
    var request = http.Request('POST', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/OTP'));
    request.body = json.encode({
...
class RoundDetails extends GetxController{
 ...
 late String Delaytimemessage;
  ...
  OnTimes() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/Ontime'));
    request.body = json.encode({
      "UserId": globaldata.GID,
      "ReportType":"Ontime"
    });
...
class Countercontroller extends GetxController{
  ...
  Future<void> Counterdata() async {
    ...
    var request = http.Request('GET', Uri.parse('http://103.25.130.254/ChennaiGaurdPetroling/Api/OntimeCount'));
    request.body = json.encode({
      "UserId": globaldata.GID,
      "ReportType":"Count"
    });
